...
import net.ukr.jura.framework.R;
import net.ukr.jura.framework.network.Api;
import net.ukr.jura.simple.base.ActivityDrawer;
...
import net.ukr.jura.simple.models.ParamView;
