package net.ukr.jura.framework.network;

import net.ukr.jura.simple.models.ParamModel;
import static net.ukr.jura.simple.models.ParamModel.POST;
...
public class Api {
    ...
    public static ParamModel LOGIN = new ParamModel(POST, "https://apidev.moneyclouds.com/auth/token",
